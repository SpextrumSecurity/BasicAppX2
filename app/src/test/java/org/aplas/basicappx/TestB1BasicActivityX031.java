   ...
   public void startTest() {
       unit = new Weight();
        ...
        public void check_02_Methods() throws NoSuchFieldException,IllegalAccessException {
            ...
            assertEquals("Wrong getOunce Method",unit.getOunce(),value/0.035274,0.01);
            assertEquals("Wrong getPound Method",unit.getPound(), value/0.00220462,0.01);
            ...
            unit.setOunce(value);
            assertEquals("Wrong setOunce Method",(double)getFieldValue(unit,"gram"),value*0.035274,0.01);
            ...
            unit.setPound(value);
            assertEquals("Wrong setPound Method",(double)getFieldValue(unit,"gram"),value*0.00220462,0.01);
